...
export function makeGetMyProfileUseCase({ playerRepo }: { playerRepo: PlayerRepository }) {
  return async function getMyProfile(playerId: string): Promise<PlayerWithMedical> {
